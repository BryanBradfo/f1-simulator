...
public class ExperienceTest {
 	...
 	@Test public void PILOTEtesterExperienceParDefault() {
		...
		System.out.println("------------------------------------------");
 		Pilote Bryan = new Pilote("Chen", "Bryan" ,"Français pur" ,1, 20 , "M" , 1.82 , 71.5, new Experience());
 	...
 	@Test public void PILOTEtesterExperience() {
		...
		System.out.println("------------------------------------------");
 		Pilote Bryan = new Pilote("Chen", "Bryan" ,"Français pur" ,1, 20 , "M" , 1.83 , 71.5, new Experience());
	...
	@Test public void PILOTEAugmenterNiveauAvec20Supplementaire() {
		...
		System.out.println("------------------------------------------");
		Pilote Bryan = new Pilote("Chen", "Bryan" ,"Français pur" ,1, 20 , "M" , 1.84 , 71.5, new Experience());
		//on arrive à 80% de barre de progression avec un boost de 20%
		Bryan.getExp().setBoost(1.0);
