...
/** Un stand est associé à un circuit. Il spécialise ElementCircuit.
* Il a un nombre de places spécifiques pour chaque monoplace.
...
public class Stands extends ElementCircuit {
	...
	public String toString() {
		return "Stands [nombrePlaces=" + nombrePlaces + ", tempsArretMoyen=" + tempsArretMoyen + "]";
	}
