...
public class ControleMenuChoixEcurie extends JPanel {
	...
	public ControleMenuChoixEcurie(ModeleMenuChoixEcurie modele) {
		...
		JScrollPane pMilieu = new JScrollPane(pNoms);
		pMilieu.setLayout(new ScrollPaneLayout());
		
		JButton bRet = new BoutonPerso("Retour");
		JButton bCreer = new BoutonPerso("Creer votre ecurie");
